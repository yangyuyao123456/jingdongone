package com.yyy.jingdongnew.dealdata;

import com.alibaba.fastjson.JSONObject;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.yyy.jingdongnew.util.JacksonUtil;
...
public class GetJson {
    ...
    public JSONObject getHttpsJson(String url){
        try {
            ...
            if(httpsConn.getResponseCode()==200){
                ...
                Object obj= JacksonUtil.jsonToObj(jsonObject,jsonString);
    ...
    public JSONObject getJsonString(String str, int comefrom) throws IOException {
        JSONObject jo = null;
        if(comefrom==1){
            JSONObject jsonObject=new JSONObject();
            Object obj= JacksonUtil.jsonToObj(jsonObject,str);
            return (JSONObject) obj;
        }else if(comefrom==2){
            int indexStart = 0;
            //字符处理
            ...
            JSONObject jsonObject=new JSONObject();
            Object obj= JacksonUtil.jsonToObj(jsonObject,strNew);
            return (JSONObject) obj;
        }
        return jo;
    }
